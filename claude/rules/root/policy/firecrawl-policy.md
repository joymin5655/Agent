...
- `uiverse.io` — Community UI components
- `reactbits.dev` — React components
- `magicui.design` — Magic UI
- `component.gallery` — UI components

### AI 에이전트 및 디자인 도구 (Ingestion Tier 1-3)

- `python.langchain.com` — LangChain Python
- `js.langchain.com` — LangChain JS
- `docs.auto-gpt.ai` — AutoGPT
- `docs.cline.bot` — Cline
- `docs.aider.chat` — Aider
- `docs.superpowers.ai` — Superpowers
- `docs.gstack.dev` — gstack
- `photopea.com` — Photopea (Design tool)
- `freepik.com` — Freepik (Assets)
- `remove.bg` — remove.bg (AI background removal)
- `higgsfield.ai` — Higgsfield AI
- `prompts3.com` — AI prompts
- `prompts.ssamgpt.com` — AI prompts
- `higgsfield.ai` — Higgsfield AI
- `v0.app` — Vercel v0 templates
- `motionsites.ai` — AI motion design
- `morphen.ai` — AI design tools

### 디자인 갤러리 및 영감 (Tier 2-4)

- `mobbin.com` — Mobbin (iOS/Android UI)
- `screensdesign.com` — ScreensDesign
- `sleek.design` — Sleek design
- `60fps.design` — Motion design
- `glass3d.dev` — 3D Glass effects
- `dribbble.com` — Dribbble
- `pinterest.com` — Pinterest
- `awwwards.com` — Awwwards
- `designspells.com` — Design spells
- `unicorn.studio` — Design inspiration
- `cta.gallery` — CTA gallery
- `toolfolio.io` — Design tools directory
- `unsection.com` — Design curation

### 마켓플레이스 및 비즈니스 (Tier 4)

- `producthunt.com` — Product Hunt
- `acquire.com` — Acquire (Marketplace)
- `flippa.com` — Flippa (Marketplace)
- `gumroad.com` — Gumroad
- `every.to` — Business/Tech newsletter

### 기술 문서 및 유틸리티

- `expo.dev` — Expo docs
- `maestro.mobile.dev` — Maestro docs
- `crontab.guru` — Crontab helper
- `fonts.google.com` — Google Fonts
- `braintrust.dev` — AI evaluation
- `figma.com` — Figma (Design system)
- `app.spline.design` — Spline 3D
- `stitch.withgoogle.com` — Stitch (Google)
- `idea-instructions.com` — Visual instructions
- `makingsoftware.com` — Software development
- `sheets.works` — Data visualization
- `chikorita.kr` — Security checklist
- `claudedesign-ppt-guide.vercel.app` — PPT guide
- `getdesign.md` — Design skills
- `lazyweb.com` — Lazyweb
- `claude.ai` — Claude design
- `developer.apple.com` — Apple Human Interface Guidelines (Deep Ingestion)
...
- AirLens 내부 path (`/workspace/internal-platform/secrets/...`)
- 사용자 PII (`redacted@example.com` 같은 이메일 — query 에 포함 금지)
