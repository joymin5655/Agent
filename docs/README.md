...
| [`concepts/fable-5-prompting.md`](concepts/fable-5-prompting.md) | Writing dispatch prompts for frontier (Fable-5-class) models — 8 rules mapped to the delegation contract |
