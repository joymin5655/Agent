...
created: 2026-04-27
updated: 2026-05-08
sources: [.claude/settings.json, .claude/agents, scripts/hooks, scripts/infra, /Users/user/.codex/skills]
...
| Codex skills | `/Users/user/.codex/skills/**` and mirror `codex/skills/**` | Codex 전용 skill 지침 |
