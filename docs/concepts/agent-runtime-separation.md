...
| Codex skills | `AirLens-web/.codex/skills/**`, `/Users/user/.codex/skills/**` | Codex 전용 skill 지침 |
...
- `AirLens-web/.codex/skills`와 `/Users/user/.codex/skills`에서 Claude 전용 실행 호출 형태(`subagent_type:`, `Agent(`, `Task(`, `/Users/user/.claude`)는 발견되지 않았다.
